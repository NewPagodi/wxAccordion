...
/// \li <span class="style">wxACCORDION_BUTTON_LEFT</span>:<div class="styleDesc"> The expand and collapse buttons, if used, are placed on the left side of the caption bar. </div>
/// \li <span class="style">wxACCORDION_SINGLE_FOLD</span>:<div class="styleDesc"> When a page is expanded, all other pages are collapsed. </div>
/// \li <span class="style">wxACCORDION_COLLAPSE_TO_BOTTOM</span>:<div class="styleDesc"> The accordion's pages are pushed to the bottom of the containing window. </div>
/// \li <span class="style">wxACCORDION_FLOAT_TO_TOP</span>:<div class="styleDesc"> Pages are moved to the top of the page set when they are expanded and restored to their original position when collapsed. </div>
///
...
/// \li <span class="event">wxEVT_ACCORDION_COLLAPSING(id,  func)</span>:<div class="eventDesc">The page selection is about to be collapsed. Processes a <code>wxEVT_ACCORDION_COLLAPSING</code> event. This event can be vetoed. </div></li>
